                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6">
                            <div className="single-team">
                                <div className="team-img">
                                    <img src="/images/team/pratik.jpg" alt="team" />
                                </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-team">
                                <div className="team-img">
                                    <img src="/images/team/anand.jpg" alt="team" />
                                </div>
                                <div className="team-content">
                                    <h3>Anand Thakur</h3>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-team">
                                <div className="team-img">
                                    <img src="/images/team/manoj.jpg" alt="team" />
                                </div>
                                ...
                                <div className="team-content">
                                    ...
                                    <ul className="social">
                                        ...
                                        <li>
                                            <a href="mailto:manoj@footprynt.in" target="mailto:manoj@footprynt.in">
                                                <i className="bx bxs-envelope"></i>
                                            </a>
                                        </li>
                                        <li>
