    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Our digital media buying strategies take into account design, copywriting, budget planning and targeting. We get you the perfect digital fit." />
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 col-md-12">
                            <div className="company-content">
                                <div className="company-tittle">
                                    ...
                                    <p style={{ fontWeight: 'bold' }}>Our digital media buying strategies take into account design, copywriting, budget planning and targeting. We get you the perfect digital fit.</p>
                                    <p>Our goal has always been to select the right purchase space on the right channel using the right platforms.   </p>
                                    <p>Our highly experienced team dwells into every keyword used, every geographical area to be targeted, every search keyword to be shortlisted and even the basic spends at the beginning of every campaign.   </p>
                                    <p> We handle small monthly budgets to annual mandates depending on the brand objectives.   </p>
                        ...
                        <div className="col-lg-6 col-md-10">
                            <div className="company-img">
                                <Image src="/images/solutions-details/fpWhat.png" width={500} height={450} alt="company" />
                            </div>
                        </div>
                    </div>
                </div>
