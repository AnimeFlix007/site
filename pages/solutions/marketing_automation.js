    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="We offer personalised experience for your customers through efficient digital marketing automated at nominal costs." />
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 col-md-12">
                            <div className="company-content">
                                <div className="company-tittle">
                                    ...
                                    <p style={{ fontWeight: 'bold' }}>We offer personalised experience for your customers through efficient digital marketing automated at nominal costs.</p>
                                    <p>We’ve used some of the best third party marketing automation tools and effectively made marketing easier for our clients in the past 3 years.   </p>
                                    <p>Simple triggers such as a survey post, a purchase or usage of a service has helped our clients retain their customers.   </p>
                                    <p> Our marketing automation helps you achieve 360 degree digital marketing solutions.   </p>
                        ...
                        <div className="col-lg-6 col-md-10">
                            <div className="company-img">
                                <Image src="/images/solutions-details/fpHow.png" width={500} height={450} alt="company" />
                            </div>
                        </div>
                    </div>
                </div>
