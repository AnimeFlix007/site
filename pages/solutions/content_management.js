    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Get your adwords in place. We create the right content for your brand. And your ads strategy? It’s whetted by our professionals." />
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-6 col-md-12">
                            <div className="company-content">
                                <div className="company-tittle">
                                    ...
                                    <p style={{ fontWeight: 'bold' }}>Get your adwords in place. We create the right content for your brand. And your ads strategy? It’s whetted by our professionals.</p>
                                    <p>While our SEO services are aimed at increasing online traffic to your business, our CRO services ensure that the traffic converts into leads.  </p>
                                    <p>We create quality lead generation campaigns with simple landing pages and convert the traffic to actual leads.  </p>
                        ...
                        <div className="col-lg-6 col-md-10">
                            <div className="company-img">
                                <Image src="/images/solutions-details/solutions-details3.png" width={500} height={450} alt="company" />
                            </div>
                        </div>
                    </div>
                </div>
