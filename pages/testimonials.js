                        ...
                        <div className="col-lg-6">
                            <div className="single-testimonials">
                                    ...
                                    <div className="row align-items-center">
                                        <div className="col-lg-3 col-md-3 col-5">
                                            <div className="testimonials-img">
                                                <img src="/images/clients/SnehaShenoy.jpg" alt="testimonials" style={{width:'6rem', height:'6rem'}} />
                                            </div>
                                        </div>
                                ...
                                <div className="testimonials-foot">
                                    <p>Footprynt has been my go to agency in the last three jobs of mine. Looking at working with them in the future.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="single-testimonials">
                                <div className="testimonials-head">
                                    <div className="row align-items-center">
                                        <div className="col-lg-3 col-md-3 col-5">
                                            <div className="testimonials-img">
                                                <img src="/images/clients/ChandanRoy.jpg" alt="testimonials" style={{width:'6rem', height:'6rem'}} />
                                            </div>
                                        </div>
                                        <div className="col-lg-9 col-md-9 col-7">
                                            <div className="content">
                                ...
                                <div className="testimonials-foot">
                                    <p>Footprynt helps us add value to the brands who come onboard for our properties. They bring in a niche and expertise rarely seen in this industry.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="single-testimonials">
                                <div className="testimonials-head">
                                    <div className="row align-items-center">
                                        <div className="col-lg-3 col-md-3 col-5">
                                            <div className="testimonials-img">
                                                <img src="/images/clients/SmritaSingh.jpg" alt="testimonials"  style={{width:'6rem', height:'6rem'}}/>
                                            </div>
                                        </div>
                                        <div className="col-lg-9 col-md-9 col-7">
                                            <div className="content">
                                ...
                                <div className="testimonials-foot">
                                    <p>Footprynt helped us increase the brand presence through curated influencer campaigns</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="single-testimonials">
                                <div className="testimonials-head">
                                    <div className="row align-items-center">
                                        <div className="col-lg-3 col-md-3 col-5">
                                            <div className="testimonials-img">
                                                <img src="/images/clients/VinayBharathwas.jpg" alt="testimonials" style={{width:'6rem', height:'6rem'}} />
                                            </div>
                                        </div>
                                        <div className="col-lg-9 col-md-9 col-7">
                                            <div className="content">
                                ...
                                <div className="testimonials-foot">
                                    <p>Stockal influencer marketing is managed by Footprynt. They have a dedicated team which has worked on all our campaigns with extremely good results. We can say we have achieved all our goals.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="single-testimonials">
                                <div className="testimonials-head">
                                    <div className="row align-items-center">
                                        <div className="col-lg-3 col-md-3 col-5">
                                            <div className="testimonials-img">
                                                <img src="/images/clients/RohanPatil.jpg" alt="testimonials" style={{width:'6rem', height:'6rem'}} />
                                            </div>
                                        </div>
                                        <div className="col-lg-9 col-md-9 col-7">
                                            <div className="content">
                                ...
                                <div className="testimonials-foot">
                                    <p>The work ethic is phenomenal and the personalization even better. This is the agency for all influencers I need.</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="single-testimonials">
                                <div className="testimonials-head">
                                    <div className="row align-items-center">
                                        <div className="col-lg-3 col-md-3 col-5">
                                            <div className="testimonials-img">
                                                <img src="/images/clients/GibsonSequeira.jpg" alt="testimonials" style={{width:'6rem', height:'6rem'}} />
                                            </div>
                                        </div>
                                        <div className="col-lg-9 col-md-9 col-7">
                                            <div className="content">
                                ...
                                <div className="testimonials-foot">
                                    <p>We have created over 2000+ videos using influencers with footprynt. The team is enthusiastic and very efficient with their work. The volume of the work and the quality is a testimonial to that.</p>
                                </div>
                            </div>
                        </div>
