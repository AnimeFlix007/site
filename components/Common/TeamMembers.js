        ...
        <div className="home-team-area ptb-100">
            <div className="container">
                <div className="section-title">
                    ...
                    <p>A team of digital marketing experts with experience in building advertising tech products, creating digital campaigns, influencer campaigns and marketing automation.</p>
                </div>
                ...
                <div className="row">
                    <div className="col-lg-4 col-md-6">
                        <div className="single-team">
                            <div className="team-img">
                                <Image src="/images/team/pratik.jpg" alt="team" width={420} height={400}/>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="single-team">
                            <div className="team-img">
                                <Image src="/images/team/anand.jpg" alt="team" width={420} height={400}/>
                                <ul className="social">
                                            <li>
                    ...
                    <div className="col-lg-4 col-md-6">
                        <div className="single-team">
                        <div className="team-img">
                            <Image src="/images/team/manoj.jpg" alt="team" width={420} height={400}/>
                            <ul className="social">
                                        <li>
                                        ...
                                        <li>
                                            <a href="https://www.instagram.com/manoj_ampolu/" target="https://www.instagram.com/manoj_ampolu/">
                                                <i className="bx bxl-instagram"></i>
                                            </a>
                                        </li>
                                    </ul>
